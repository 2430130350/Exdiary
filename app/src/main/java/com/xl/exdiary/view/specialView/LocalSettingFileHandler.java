...
public class LocalSettingFileHandler{
    private LocalSetting localSetting;
    private Context context;

    public LocalSettingFileHandler(Context context, LocalSetting localSetting){
    ...
    * */
    public LocalSetting getLocalSetting(){
        try{
            ...
            FileInputStream fileInputStream = new FileInputStream(path + "/localSettingFile.set");
            ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
            this.localSetting = (LocalSetting) objectInputStream.readObject();
    ...
    public void setLocalSetting(){
        try{
            String path = context.getExternalCacheDir().getAbsolutePath();
            FileOutputStream fileOutputStream = new FileOutputStream(path + "/localSettingFile.set");
            ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream);
            objectOutputStream.writeObject(this.localSetting);
    ...
    public static String getRealPathFromUriMAX(Context context, Uri uri) {
